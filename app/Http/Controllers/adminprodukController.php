...
class adminprodukController extends Controller
{
    ...
    {
        return view('layouts.pages.product.adminindex');
    }
    ...
    public function show($id)
    {
        ...
        return view('layouts.pages.product.adminshow',compact('model'));
    }
    ...
    public function edit($id)
    {
        $model = Product::findOrFail($id);
        $states = setup_prop::pluck('NAMA_PROP','NO_PROP');
        return view('layouts.pages.product.adminform',compact('model','states'));
    }
...
/*     public function dataTable()
    ...
    public function dataTable()
    {
        ...
        $model =DB::table('products')->select(['id', 'name', 'SN_Device', 'NO_Sam','publish','Kota','User_Name','User_Name','active',])
        ...
        return DataTables::of($model)
            ->addColumn('action', function ($model) {
                return view('layouts._adminaction', [
                    'model' => $model,
                    'url_show' => route('produk.show', $model->id),
                    'url_edit' => route('produk.edit', $model->id),
                    'url_destroy' => route('produk.destroy', $model->id),
