...
Route::get('/importExportView', 'ExcelController@importExportView')->name('importview');
Route::Post('/importExportView', 'ExcelController@Import')->name('import');
...
Route::get('/table/Adminreport', 'AdminReportController@dataTable')->name('table.admin');
